...
if __name__ == "__main__":
    ...
    if "--designs-na" in sys.argv:
        # L2 check of the neural-adjoint winners (produces the
        # design_rcwa_check_na.csv cited in the README — previously this file
        # could only be regenerated by editing the function call by hand)
        verify_designs(csv_in=res_path("optimal_designs_na.csv"),
                       csv_out=res_path("design_rcwa_check_na.csv"))
